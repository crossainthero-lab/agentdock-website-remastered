      ...
      >
        <div className="p-8 md:p-12 border border-[var(--color-accent-amber-border)] bg-gradient-to-br from-[var(--color-ad-surface)] to-[#151108] rounded-xl relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Go further with AgentDock Pro</h2>
            <ul className="text-[var(--color-ad-text-muted)] space-y-2 mb-6 text-sm">
              <li>• Unlocks advanced multi-agent coordination.</li>
              <li>• AIgency is its flagship orchestration mode.</li>
              <li>• Expands AgentDock with optional cloud, remote, sync, and collaboration services.</li>
              <li>• The desktop application remains the core experience.</li>
            </ul>
            <Link to="/pro" className="inline-flex items-center gap-2 text-sm font-medium text-[var(--color-accent-amber)] hover:text-amber-300 transition-colors">
              Explore AgentDock Pro <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
